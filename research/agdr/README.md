...
| Record | Decision |
|---|---|
| [AgDR-0001](AgDR-0001-shared-backend-naming-scope-isolation.md) | Isolate agent environments on one shared Floci backend by recording which environment owns each resource, not per-environment infrastructure |
